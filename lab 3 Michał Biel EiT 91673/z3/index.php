...
<form action='<?php echo $_SERVER['PHP_SELF']; ?>#galeria' method='post' name='form_filter' > 
	<select name="value">
    <option value="standing">Pozycja stojąca</option>
    <option value="sitting">Pozycja siedząca</option>
...
if($_POST['value'] == 'standing') {
    
    $resultSet = $mysqli->query("SELECT * FROM tabela1");
    ?>
    <table id="tabelka">
                        <tr>
                            
                            
                            <td><?php echo "Zdjęcia"; ?></td>
                        </tr>
<?php
...
<tr>
                                ...
                                <td class="otherC">
                                    <div class="item">
                                    <img src="img/<?php echo $photo; ?>/<?php echo $link; ?>">
                                <span class="caption"><?php echo $kome; ?></span>
                                </div>
...
elseif($_POST['value'] == 'sitting') { 
    // query to get all Herring records 
    $resultSet = $mysqli->query("SELECT * FROM tabela1 WHERE galeria='sitting'");
    ?>
                <table id="tabelka">
                        <tr>
...
?>
    ...
    elseif($_POST['value'] == 'portraits') { 
    // query to get all Herring records 
    $resultSet = $mysqli->query("SELECT * FROM tabela1 WHERE galeria='portraits'");
    ?>
    <table id="tabelka">
                        <tr>
...
elseif($_POST['value'] == 'interesting') { 
    // query to get all Herring records 
    $resultSet = $mysqli->query("SELECT * FROM tabela1 WHERE galeria='interesting'");
    ?>
...
elseif($_POST['value'] == 'perspective') { 
    $resultSet = $mysqli->query("SELECT * FROM tabela1 WHERE galeria='perspective'");
    ?>
