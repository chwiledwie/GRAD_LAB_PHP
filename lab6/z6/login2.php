...
if ($_POST['send'] == 1) {
    ...
    $userExists = mysql_query("SELECT * FROM user WHERE login = '$login' AND password = '$pass' LIMIT 1;");
   $bla = mysql_fetch_array($userExists);
    ...
    if ($bla[0] == 0) {
        ...
        echo '<p class="success">Zostałeś zalogowany. Przejdź do panelu administratora <a href="add.php">tutaj</a></p>';
