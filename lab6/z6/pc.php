    ...
    <section id="announcement">
        ...
        <table id="sidebarleft">
            ...
            <tr><td> <a href="pcD.php#announcement"><div>Dostawy</div></a></td></tr>
                     ...
                     <tr><td><form action="pcF.php#announcement" method="POST">
                         <label for="f">Filtruj wg: </label>
<select name="filtr" id="f"> 
<option value="namead">Nazwy</option> 
...
<label for="f">Słowo kluczowe: </label>
<input type=text name="sl"/><br/>
<input type=submit name="ff" value="Filtruj"/><br/>
                     </form></td></tr>
...
<td class="otherC">
 ...
 <?php echo $about;?>
    ...
    <td class="otherC">
        <!-- a link + zapytanie aby w nowym oknie były dane z tabeli userd-->
