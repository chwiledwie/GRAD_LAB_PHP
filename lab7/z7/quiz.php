   ...
   <div style="clear:both;"></div>
        ...
        ?>
            <table class="tabelkaG"> 
                <tr style="background-color: lightgrey;"><td style=" border-bottom: 2px solid #222;">
                    Quiz
                        
                    </td></tr>
                <form action="wynik.php#e-learn" method="POST">
                <?php
                $x=0;
$utf8 = ('SET NAMES utf8');
...
while ($row = mysql_fetch_assoc($question))
{
   ...
   echo '<input type="checkbox" name="cb'.$x.'[]" value=' .$row['choice1'] . ' />' .$row['choice1'] . '<br />';
   echo '<input type="checkbox" name="cb'.$x.'[]" value=' .$row['choice2'] . ' />' .$row['choice2'] . '<br />';
   echo '<input type="checkbox" name="cb'.$x.'[]" value=' .$row['choice3'] . ' />' .$row['choice3'] . '<br />';
   $x=$x+1;
...
?>
            ...
            <tr><td>
    <input type=submit name="submit" value="Twój wynik"/><br/>
