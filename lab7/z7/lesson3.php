...
<!—Rozpoczynamy menu, przy użyciu nav -->
   <nav id="menu" role="navigation">
       <ul class="w3-navbar">
         ...
         <li><a href="..\z7\#e-learn">E-nauczanie</a></li>
         
    <li><a href="..\z7\#contactme">Kontakt</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">E-learning</h2>
                    <h3 class="section-subheading text-muted">Życzymy owocnej nauki</h3>
            ...
            <tr><td>Informacje ogólne</td></tr>
            <tr><td><a href="lesson1.php#e-learn"><div>Lekcja 1</div></a></td></tr>
            <tr><td> <a href="lesson2.php#e-learn"><div>Lekcja 2</div></a></td></tr>
                     <tr><td><a href="lesson3.php#e-learn"><div>Lekcja 3</div></a></td></tr>
                     <tr><td> <a href="podsumowanie.php#e-learn"><div>Podsumowanie</div></a></td></tr>
                     <tr><td> <a href="quiz.php#e-learn"><div>Quiz</div></a></td></tr>
...
<script type="text/javascript" src="//cdn.bannersnack.com/iframe/embed.js"></script>
   ...
   <div style="clear:both;"></div>
        ...
        <table class="tabZ">
            <tr><td class="tdN">Lekcja 3</td></tr>
                    <tr><td class="tdZ">
                            <p class="Z">Pasmo przenoszenia głosu - zakres częstotliwości niezbędny do przenoszenia sygnałów mowy. 
                                Głos ludzki zawiera wiele częstotliwości podstawowych i harmonicznych, których zestaw nadaje ton i barwę charakterystyczną dla każdego rozmówcy. 
                                Dla dobrego zrozumienia mowy i rozpoznania głosu osoby mówiącej wystarczy pasmo, w którym jest zawarta główna część energii, w zakresie 300-3400 Hz.

Ze względów ekonomicznych zdecydowano transmitować w urządzeniach telefonicznych pasmo o szer. 3,1 kHz (niekiedy 3,3 kHz w zakresie 200-3500 Hz), zapewniające właściwe zrozumienie mowy. 
...
Zgodnie z prawem Shannona częstotliwość próbkowania sygnału analogowego winna być co najmniej dwa razy większa i wynosić 8 kHz. 
Do transmisji dźwięku (również tego o wysokiej jakości) przyjmuje się pasmo w zakresie częstotliwości naturalnych od 20 Hz 16 kHz.
