...
?>
    ...
    <tr><td><a href="statPiw.php#kom">Pracownicy posortowani wg. ilości wypożyczeń</a></td></tr>
      ...
      <p class="pasekK">Wypożyczone książki:</p>
...
$wynik = mysql_query($utf8) or die(mysql_error());  
    ...
    $zapytanie = mysql_query("SELECT * FROM wypozyczenia;"); //wybiera tabelę i pobiera z niej wszystkie dane
...
echo' <tr><td>Data zwrotu: '.$shit['DataZwrotu'].', Tytuł: '.$wynikK1[5].', Autor: '.$wynikA1[1].' '.$wynikA1[2].', Rok wydania: '.$wynikK1[6].'</td>
